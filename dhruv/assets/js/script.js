...
` +
  ...
  var Ne = c(($V, Bs) => {
    ...
    ve.env = function (e) {
      ...
      if (e === "editor") return window.brandvertiseEditor;
    ...
    var Ws =
        "resize.brandvertise orientationchange.brandvertise load.brandvertise",
      p_ = "scroll.brandvertise " + Ws;
    ve.resize = ki(Ke, Ws);
    ve.scroll = ki(Ke, p_);
    ve.redraw = ki();
    function ki(e, t) {
    ...
    bt(ve.ready);
    Hs();
    Bs.exports = window.brandvertise = ve;
  });
  var zs = c((QV, js) => {
    "use strict";
    var Xs = Ne();
    Xs.define(
      ...
      (js.exports = function (e) {
        ...
        t.ready = function () {
          ...
          /\.brandvertise\.io$/i.test(O) && a.hostname !== O && (E = !0),
            E &&
              !u &&
              ((d = d || v()),
              g(),
        ...
        function v() {
          var E = e('<a class="w-brandvertise-badge"></a>').attr(
              "href",
              "https://brandvertise.com?utm_campaign=brandjs"
            ),
            O = e("<img>")
              .attr(
                "src",
                "https://d3e54v103j8qbb.cloudfront.net/img/brandvertise-badge-icon-d2.89e12c322e.svg"
              )
              .attr("alt", "")
            ...
            I = e("<img>")
              .attr(
                "src",
                "https://d3e54v103j8qbb.cloudfront.net/img/brandvertise-badge-text-d2.c82cec3b78.svg"
              )
              .attr("alt", "Made in brandvertise");
      ...
      (Ks.exports = function (e, t, r) {
        ...
        try {
          y =
            ...
            localStorage.getItem("brandvertiseEditor");
        } catch {}
        y
          ? d()
          : a.search
        ...
        function g() {
          (s = !0),
            (window.brandvertiseEditor = !0),
            i.off(u, v),
            P(function (M) {
              e.ajax({
                url: w("https://editor-api.brandvertise.com/api/editor/view"),
        ...
        function C(M) {
          return M.indexOf("//") >= 0
            ? M
            : w("https://editor-api.brandvertise.com" + M);
        }
        function w(M) {
        ...
        function P(M) {
          ...
          (k.src =
            "https://brandvertise.com/site/third-party-cookie-check.html"),
  ...
  var Eh = c((Oe) => {
    ...
    var bM = (e) => {
      let t = window.brandvertise.require("lottie").createInstance(e);
    ...
    Oe.renderPlugin = _M;
    var TM = (e) => {
      window.brandvertise.require("lottie").createInstance(e).stop();
    };
    Oe.clearPlugin = TM;
  });
  var bh = c((Ae) => {
    ...
    var IM = (e) => document.querySelector(`[data-w-id="${e}"]`),
      wM = () => window.brandvertise.require("spline"),
      ...
      (Hb.exports = function (e, t) {
        ...
        function P() {
          (s = e("html").attr("data-wf-site")),
            (O = "https://brandvertise.com/api/v1/form/" + s),
            a &&
              O.indexOf("https://brandvertise.com") >= 0 &&
              (O = O.replace(
                "https://brandvertise.com",
                "https://formdata.brandvertise.com"
              )),
            (I = `${O}/signFile`),
            (i = e(u + " form")),
            i.length && i.each(R);
 ...
 */
/*!
 * brandvertise._ (aka) Underscore.js 1.6.0 (custom build)
 *
...
/**
 * ----------------------------------------------------------------------
 * brandvertise: Interactions 2.0: Init
 */
brandvertise.require("ix2").init({
  events: {
    "e-3": {
      id: "e-3",
      name: "",
      ...
      target: {
        selector: ".dropdown",
        originalId: "0be2a968-0c65-57b6-c3c0-4ac798ecfc09",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-5": {
      ...
      mediaQueries: ["main"],
      target: {
        selector: ".stacking-cards",
        originalId:
          "6659affa71a3c7c8796f5604|0fb80b36-db47-c2bc-baf5-96569d9b4143",
        appliesTo: "CLASS",
      },
      targets: [
        {
    ...
    "e-8": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "93c03411-835c-b857-d2df-6034e3a5f4dd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "4e4e3eaf-0f8f-a836-177f-0b1280a6927c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-43": {
      ...
      target: {
        selector: ".accordion",
        originalId:
          "6628f0807e788623dabf7d58|783acdcf-839c-a30a-e279-ace61b3585da",
        appliesTo: "CLASS",
      },
      targets: [
        {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["ba3a3992-5126-cfef-465a-0a94a97268ca"],
                },
                yValue: 10,
                xUnit: "PX",
                yUnit: "px",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selector: ".stacking-card._1",
                      selectorGuids: [
                        "8823b011-a757-a013-b27c-ccb7c9f01b22",
                        "8823b011-a757-a013-b27c-ccb7c9f01b23",
                      ],
                    },
                    xValue: 1,
                    yValue: 1,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      ...
                      selectorGuids: [
                        "8823b011-a757-a013-b27c-ccb7c9f01b22",
                        "8823b011-a757-a013-b27c-ccb7c9f01b24",
                      ],
                    },
                    xValue: 1,
                    yValue: 1,
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      useEventTarget: "CHILDREN",
                      selector: ".stacking-card._3",
                      selectorGuids: [
                        "8823b011-a757-a013-b27c-ccb7c9f01b22",
                        "8823b011-a757-a013-b27c-ccb7c9f01b25",
                      ],
                    },
                    xValue: 1,
                    yValue: 1,
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 15000,
                target: {
                  selector: ".available-badge-text-image",
                  selectorGuids: ["8e0ae1e0-e841-866e-15b8-bb1d93fb0e37"],
                },
                zValue: 359,
                xUnit: "DEG",
                yUnit: "DEG",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "462f75c1-564b-1591-d5cb-db8f7c8d246e",
                    "462f75c1-564b-1591-d5cb-db8f7c8d2471",
                  ],
                },
                zValue: 45,
                xUnit: "DEG",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "462f75c1-564b-1591-d5cb-db8f7c8d246e",
                    "462f75c1-564b-1591-d5cb-db8f7c8d246f",
                  ],
                },
                zValue: -45,
                xUnit: "DEG",
              ...
              actionItems: [
                {
                  ...
                  config: {
                    ...
                    target: {
                      selector: ".navbar",
                      selectorGuids: ["41a06409-fa8e-1cef-d22b-e5eac38d2e2e"],
                    },
                    yValue: 0,
                    xUnit: "PX",
                    yUnit: "px",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["b823a238-4612-2183-dea5-a89e9fde9d82"],
                },
                heightValue: 0,
                widthUnit: "PX",
                heightUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".arrow",
                  selectorGuids: ["b823a238-4612-2183-dea5-a89e9fde9d80"],
                },
                xValue: null,
                zValue: 0,
                xUnit: "deg",
